    ...
    <ImageSection align="left">
      <ImageSectionContent>
        ...
        <p className="text-md text-gray-700">
          ...
          monitoring of brain health should be accessible, simple, and reliable.
          Our handheld medical device, iTremor One, offers a rapid, non-invasive
          way to assess brain impairment caused by concussion, Parkinson&apos;s
          Disease, Multiple Sclerosis, stroke, and other neurological conditions
          — all from the comfort of your home or clinic.
        </p>
      </ImageSectionContent>
      <ImageSectionImage
